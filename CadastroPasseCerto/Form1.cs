...
namespace CadastroPasseCerto
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Ficha salva!" + NEW_LINE + "Confira em: " + caminho);
            clearForm();
        }
        ...
        private String getDadosAluno()
        {
            ...
            dadosAluno.Append(NEW_LINE);
            dadosAluno.Append("Bairro: " + bairroAluno.Text + TAB + "Cidade: " + cidadeAluno.Text);
            dadosAluno.Append(NEW_LINE);
            dadosAluno.Append("Data de Nascimento: " + nascimentoAluno.Text + TAB + "CEP: " + cepAluno.Text);
            dadosAluno.Append(NEW_LINE);
            dadosAluno.Append("CPF: " + cpfAluno.Text + TAB + "RG: " + rgAluno.Text);
            dadosAluno.Append(NEW_LINE);
            dadosAluno.Append(NEW_LINE);
            dadosAluno.Append(NEW_LINE);
